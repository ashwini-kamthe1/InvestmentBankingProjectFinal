package com.zerodha.QA11.Utils;
...
public class Util  extends TestBase{
		...
		// ============================ Screen Shot Utillity ==================================================
			...
			File dest = new File("D:\\eclipse-workspace\\com.zerodha1.QA11\\Screenshots\\screenshot"+filename);
		...
		public static String getStringTestData(int row, int col) throws EncryptedDocumentException, IOException {
			FileInputStream file = new FileInputStream("D:\\eclipse-workspace\\com.zerodha1.QA11\\src\\main\\java\\com\\zerodha\\QA11\\Testdata\\TestData.xlsx");
